...
lista = [
    ...
    { 'type': 'CEDEAR', 'id': 3,   'ticker': 'ABT',	    'ratio': 4,	    'nombre': 'Abbott Laboratories'},
    { 'type': 'CEDEAR', 'id': 4,   'ticker': 'ADBE',	'ratio': 22,	'nombre': 'Adobe Inc.'},
    ...
    { 'type': 'CEDEAR', 'id': 8,   'ticker': 'AMGN',	'ratio': 10,	'nombre': 'Amgen Inc.'},
    { 'type': 'CEDEAR', 'id': 9,   'ticker': 'AMX',	    'ratio': 1,	    'nombre': 'América Móvil, S.A.B. de C.V.'},
    { 'type': 'CEDEAR', 'id': 10,  'ticker': 'AMZN',	'ratio': 144,	'nombre': 'Amazon.com, Inc.'},
    ...
    { 'type': 'CEDEAR', 'id': 14,  'ticker': 'BA',	    'ratio': 6,	    'nombre': 'The Boeing Company'},
    ...
    { 'type': 'CEDEAR', 'id': 18,  'ticker': 'BHP',	    'ratio': 2,	    'nombre': 'BHP Group'},
    { 'type': 'CEDEAR', 'id': 19,  'ticker': 'BIDU',	'ratio': 11,	'nombre': 'Baidu, Inc.'},
    { 'type': 'CEDEAR', 'id': 20,  'ticker': 'BIIB',	'ratio': 13,	'nombre': 'Biogen Inc.'},
    { 'type': 'CEDEAR', 'id': 21,  'ticker': 'BMY',	    'ratio': 3,	    'nombre': 'Bristol-Myers Squibb Company'},
    ...
    { 'type': 'CEDEAR', 'id': 29,  'ticker': 'COST',	'ratio': 12,	'nombre': 'Costco Wholesale Corporation'},
    ...
    { 'type': 'CEDEAR', 'id': 36,  'ticker': 'DE',	    'ratio': 10,	'nombre': 'Deere & Company'},
    ...
    { 'type': 'CEDEAR', 'id': 39,  'ticker': 'EBAY',	'ratio': 2,	    'nombre': 'eBay Inc.'},
    ...
    { 'type': 'CEDEAR', 'id': 43,  'ticker': 'FDX',	    'ratio': 10,	'nombre': 'FedEx Corporation'},
    ...
    { 'type': 'CEDEAR', 'id': 49,  'ticker': 'GLOB',	'ratio': 6,	    'nombre': 'Globant S.A.'},
    { 'type': 'CEDEAR', 'id': 50,  'ticker': 'GOLD',	'ratio': 1,	    'nombre': 'Barrick Gold Corporation'},
    { 'type': 'CEDEAR', 'id': 51,  'ticker': 'GOOGL',	'ratio': 58,	'nombre': 'Alphabet Inc.'},
    ...
    { 'type': 'CEDEAR', 'id': 55,  'ticker': 'HD',	    'ratio': 8,	    'nombre': 'The Home Depot, Inc. '},
    ...
    { 'type': 'CEDEAR', 'id': 69,  'ticker': 'KMB',	    'ratio': 6,	    'nombre': 'Kimberly-Clark Corporation'},
    { 'type': 'CEDEAR', 'id': 70,  'ticker': 'KO',	    'ratio': 5,	    'nombre': 'The Coca-Cola Company'},
    { 'type': 'CEDEAR', 'id': 71,  'ticker': 'LMT',	    'ratio': 20,	'nombre': 'Lockheed Martin Corporation'},
    { 'type': 'CEDEAR', 'id': 72,  'ticker': 'LVS',	    'ratio': 2,	    'nombre': 'Las Vegas Sands Corp.'},
    { 'type': 'CEDEAR', 'id': 73,  'ticker': 'LYG',	    'ratio': 2,	    'nombre': 'Lloyds Banking Group plc'},
    { 'type': 'CEDEAR', 'id': 74,  'ticker': 'MCD',	    'ratio': 8,	    'nombre': 'McDonald\'s Corporation'},
    { 'type': 'CEDEAR', 'id': 75,  'ticker': 'MDT',	    'ratio': 4,	    'nombre': 'Medtronic plc'},
    { 'type': 'CEDEAR', 'id': 76,  'ticker': 'MELI',	'ratio': 60,	'nombre': 'Mercadolibre, Inc.'},
    ...
    { 'type': 'CEDEAR', 'id': 80,  'ticker': 'MSFT',	'ratio': 10,	'nombre': 'Microsoft Corporation'},
    { 'type': 'CEDEAR', 'id': 81,  'ticker': 'MSI',	    'ratio': 5,	    'nombre': 'Motorola Solutions, Inc.'},
    { 'type': 'CEDEAR', 'id': 82,  'ticker': 'NEM',	    'ratio': 3,	    'nombre': 'Newmont Corporation'},
    ...
    { 'type': 'CEDEAR', 'id': 87,  'ticker': 'NVDA',	'ratio': 24,	'nombre': 'NVIDIA Corporation'},
    { 'type': 'CEDEAR', 'id': 88,  'ticker': 'NVS',	    'ratio': 4,	    'nombre': 'Novartis AG'},
    ...
    { 'type': 'CEDEAR', 'id': 91,  'ticker': 'PEP',	    'ratio': 6,	    'nombre': 'PepsiCo, Inc.'},
    ...
    { 'type': 'CEDEAR', 'id': 95,  'ticker': 'PYPL',	'ratio': 8,	    'nombre': 'PayPal Holdings, Inc.'},
    ...
    { 'type': 'CEDEAR', 'id': 100, 'ticker': 'SAP',	    'ratio': 6,	    'nombre': 'SAP SE'},
    { 'type': 'CEDEAR', 'id': 101, 'ticker': 'SBS',	    'ratio': 0.5,	'nombre': 'Companhia de Saneamento Básico do Estado de São Paulo'},
    { 'type': 'CEDEAR', 'id': 102, 'ticker': 'SBUX',	'ratio': 4,	    'nombre': 'Starbucks Corporation'},
    ...
    { 'type': 'CEDEAR', 'id': 106, 'ticker': 'SNE',	    'ratio': 4,	    'nombre': 'Sony Corporation'},
    ...
    { 'type': 'CEDEAR', 'id': 116, 'ticker': 'TWTR',	'ratio': 2,	    'nombre': 'Twitter, Inc.'},
